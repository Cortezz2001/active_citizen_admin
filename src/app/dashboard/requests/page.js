                  ...
                  {isStatusDropdownOpen && (
                    <div className="absolute top-full left-0 right-0 mt-1 bg-light-surface dark:bg-dark-surface border border-light-border dark:border-dark-border rounded-md shadow-lg z-50">
                      ...
                      <button
                        ...
                        className={`w-full text-left px-3 py-2 hover:bg-light-border dark:hover:bg-dark-border ${filters.status === 'In progress' ? 'bg-light-border dark:bg-dark-border' : ''}`}
                      >
                        В процессе
                      </button>
                      <button
                        ...
                        className={`w-full text-left px-3 py-2 hover:bg-light-border dark:hover:bg-dark-border ${filters.status === 'Rejected' ? 'bg-light-border dark:bg-dark-border' : ''}`}
                      >
                        Отклонено
                      </button>
                      <button
                        ...
                        className={`w-full text-left px-3 py-2 hover:bg-light-border dark:hover:bg-dark-border ${filters.status === 'Completed' ? 'bg-light-border dark:bg-dark-border' : ''}`}
                      >
                        Завершено
                      </button>
                    </div>
